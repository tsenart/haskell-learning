...
Instructions
^^^^^^^^^^^^
Spend about 3 hours on it, though it doesn't matter if you go over this.
The solution must be written in Haskell, along with a description of your
approach and any assumption you've made or problems you ran into during the test.
It may not be possible to complete the test in the given time, that's okay.
Treat it as a real world exercise.
```
